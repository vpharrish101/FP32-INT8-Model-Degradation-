...
class ImageDegrader:
    ...
    def __init__(self,csv=None,src=None,out=None):
        self.df=pd.read_csv(csv)
        self.src=Path(src)
        self.out=Path(out)

    def motion_blur(self,img,kernel=15):
        k=np.zeros((kernel,kernel),np.float32)
        k[kernel//2,:]=1/kernel
...
def main():
    ...
    ImageDegrader("data/coco2017/coco_500_val.csv",
                  "data/coco2017/val2017",
                  "data/coco2017/degraded",).generate()
